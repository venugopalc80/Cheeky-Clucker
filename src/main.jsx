...
function App(){
  ...
  {...menu[4],image:"https://images.unsplash.com/photo-1606755962773-d324e0a13086?auto=format&fit=crop&w=1000&q=85"}
      ...
      <section id="gallery" className="gallery paper"><div className="section-head"><div><p className="label">FOLLOW THE FLOCK</p><h2>GALLERY</h2></div><a className="btn outline dark" href="https://www.instagram.com/cheekycluckeruk/" target="_blank" rel="noreferrer"><Instagram size={18}/> FOLLOW ON INSTAGRAM</a></div><div className="gallery-grid"><div className="g g0" key={i}><img src="https://images.unsplash.com/photo-1562967914-608f82629710?auto=format&fit=crop&w=1200&q=85" alt="Fried chicken & loaded fries" loading="lazy"/><small>CHEEKY CLUCKER</small></div><div className="g g1" key={i}><img src="https://images.unsplash.com/photo-1626082927389-6cd097cdc6ec?auto=format&fit=crop&w=1000&q=85" alt="Signature wings" loading="lazy"/><small>CHEEKY CLUCKER</small></div><div className="g g2" key={i}><img src="https://images.unsplash.com/photo-1562967914-608f82629710?auto=format&fit=crop&w=1000&q=85" alt="Crispy chicken" loading="lazy"/><small>CHEEKY CLUCKER</small></div><div className="g g3" key={i}><img src="https://images.unsplash.com/photo-1606755962773-d324e0a13086?auto=format&fit=crop&w=1000&q=85" alt="Loaded fries" loading="lazy"/><small>CHEEKY CLUCKER</small></div><div className="g g4" key={i}><img src="https://images.unsplash.com/photo-1568901346375-23c9450c58cd?auto=format&fit=crop&w=1000&q=85" alt="Cheeky Clucker spread" loading="lazy"/><small>CHEEKY CLUCKER</small></div><div className="g g5" key={i}><img src="https://images.unsplash.com/photo-1573080496219-bb080dd4f877?auto=format&fit=crop&w=1000&q=85" alt="Cheeky Clucker restaurant atmosphere" loading="lazy"/><small>CHEEKY CLUCKER</small></div></div></section>
